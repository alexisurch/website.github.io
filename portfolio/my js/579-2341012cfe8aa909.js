    ...
    8357: function(t, e, s) {
        ...
        function u(t) {
            return t && t.map((function(t, e) {
                return n.createElement(t.tag, o({
                    key: e
                }, t.attr), u(t.child))
            }
            ))
        ...
        function c(t) {
            var e = function(e) {
                var s, r = t.attr, i = t.size, u = t.title, l = a(t, ["attr", "size", "title"]), c = i || e.size || "1em";
                return e.className && (s = e.className),
                    ...
                    return n(t, [{
                        ...
                        value: function(t, e) {
                            ...
                            !0 !== this.pause.status ? this.timeout = setTimeout((function() {
                                e = i.htmlParser.typeHtmlChars(t, e, s);
                                var n = 0
                                  , o = t.substr(e);
                                ...
                                s.timeout = setTimeout((function() {
                                    s.toggleBlinking(!1),
                                    e >= t.length ? s.doneTyping(t, e) : s.keepTyping(t, e, r),
                        ...
                        value: function(t, e) {
                            ...
                            if (!0 !== this.pause.status) {
                                ...
                                this.timeout = setTimeout((function() {
                                    e = i.htmlParser.backSpaceHtmlChars(t, e, s);
                                    var n = t.substr(0, e);
                                    if (s.replaceText(n),
                                    s.smartBackspace) {
                                        var r = s.strings[s.arrayPos + 1];
                                        r && n === r.substr(0, e) ? s.stopNum = e : s.stopNum = 0
                                    }
                                    e > s.stopNum ? (e--,
